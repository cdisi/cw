...
public class OSDAO {
	private static final String FIND_BY_ID = "SELECT * FROM os WHERE id = ?";		
	private static final String INSERT = "INSERT INTO os (ad) VALUES (?)";
	private static final String FIND_BY_NAME = "SELECT * FROM os WHERE ad = ?";	
	private static final String ALL = "SELECT * FROM os ORDER BY ad";
