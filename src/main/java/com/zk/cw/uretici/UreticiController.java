...
*/
final class UreticiController implements ActionListener {
  ...
  */
  UreticiController(MovieView aView, Edit aEdit){
    fView = aView;
    fEdit = aEdit;
  }
  ...
  */
  ...
  private static final Logger fLogger = Util.getLogger(UreticiController.class);
